...
<body>
        ...
        if ($list) { ?>
            <table class="order" width = "70%">
                ...
                foreach ($list as $key => $value) { ?>
                    <tr>
                        ...
                        <td>
                            <input id="<?= $value['productId'] ?>" type="number" name="size" class="size" value="<?= $value['size']  ?>" onchange="updateSize(this)"  min="35">
                        </d>
                        <td>
            ...
            <div class="orderinfo">
                <div class="buy">
                    ...
                    <div>
                        Size: <b><b id="qtycart"><?= $size['size'] ?></b>
                    </div>
                    <div>
    ...
    <footer>
        ...
        <p class="copyright">copy by HĐ-SHOP.com 2022</p>
    </footer>
</body>
